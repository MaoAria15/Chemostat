...
#OTU table
host_mat <- read.csv('Data/Virome/Host_prediction.csv')
...
taxonomy[] <- lapply(taxonomy, function(x) gsub("(f__|d__|c__|o__|p__|g__)", "", x))
...
write.csv(taxonomy,"Data/Virome/host_taxonomy.csv")
