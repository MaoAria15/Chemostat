...
tax_table(ps1) <- as.matrix(taxonomy)
vir.phyl <- tax_glom(ps1, "Family", NArm = FALSE)
...
p_abundance_heatmap_euk_slow <-amp_heatmap(PSVamp,
...
p_abundance_heatmap_euk_fast <-amp_heatmap(PSVamp,
                                      group_by = "Cultivation_phase",
                                      facet_by = "Dilution_rate",
                                      plot_values = FALSE,
                                      tax_show = 12,
  ...
  theme_classic() +
  mytheme_abundance_text_vertical
p_abundance_heatmap_euk_fast


############################################################################

ggarrange(p_abundance_heatmap_euk_slow,
          p_abundance_heatmap_euk_fast,
          nrow = 1,
          ncol = 2,
          labels = c("A","B")
