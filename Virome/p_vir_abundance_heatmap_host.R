...
ps <- subset_samples(PSV.HOST, Sample_origin %in% "Mice")
############################################Slow#######################################
...
p_abundance_heatmap_host_slow <-amp_heatmap(PSVamp,
...
p_abundance_heatmap_host_fast <-amp_heatmap(PSVamp,
                                           group_by = "Cultivation_phase",
                                           facet_by = "Dilution_rate",
                                           plot_values = FALSE,
                                           tax_show = 20,
  ...
  theme_classic() +
  mytheme_abundance_text_vertical
p_abundance_heatmap_host_fast

########################################

ggarrange(p_abundance_heatmap_host_slow,
          p_abundance_heatmap_host_fast,
          nrow = 1,
          ncol = 2,
          labels = c("C","D"))
